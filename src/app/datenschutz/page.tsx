  ...
  return (
    <main className="mx-auto max-w-4xl p-6">
      ...
      <div className="mt-6 space-y-4 text-sm text-ink-700">
        <p>Diese Vorlage dient als Ausgangspunkt für ein CRM-Demosystem nach DSGVO-Grundsätzen.</p>
        <p>Verarbeitet werden nur Geschäftskontaktdaten, Projekt-, Aufgaben-, Termin- und Dokumentenmetadaten.</p>
        <p>Betroffenenrechte werden über Export- und Soft-Delete-Funktionen unterstützt.</p>
